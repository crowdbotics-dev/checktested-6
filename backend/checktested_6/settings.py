"""
Django settings for checktested_6 project.
...
ROOT_URLCONF = 'checktested_6.urls'
...
WSGI_APPLICATION = 'checktested_6.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "checktested_6 API",
    "DESCRIPTION": "API documentation for checktested_6 App",
    "VERSION": "v1",
}
